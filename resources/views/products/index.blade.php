...
<div class="container mt-5">
    <div class="row">
        <!-- Leva kolona - proizvodi -->
        <div class="col-md-8">
            <h2 class="mb-4">Odabrani kursevi ovog meseca</h2>

            @foreach ($products->whereIn('id', [1, 11, 12, 14]) as $product)
                <div class="card mb-4 shadow-sm rounded product-card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Iznos:</strong> {{ number_format($product->price, 2) }} RSD</p>
